...
static std::map<std::string, Dart_NativeFunction> FUNCTIONS_MAP =
{
  ...
  { "stroke_extents", CairoDart::stroke_extents },
...
void CairoDart::stroke_preserve(Dart_NativeArguments args)
{
    Context* ctx = Utils::thisFromArg<Context>(args);
    ctx->strokePreserve();
...
void CairoDart::stroke_extents(Dart_NativeArguments args)
{
    Context* ctx = Utils::thisFromArg<Context>(args);
    double x1, y1, x2, y2;
...
void CairoDart::reset_clip(Dart_NativeArguments args)
{
    Context* ctx = Utils::thisFromArg<Context>(args);
    ctx->resetClip();
    Dart_SetReturnValue(args, Dart_Null());
...
void CairoDart::clip_extents(Dart_NativeArguments args)
{
    Context* ctx = Utils::thisFromArg<Context>(args);
    double x1, y1, x2, y2;
...
// cairo_font_face_t
void CairoDart::font_face_get_type(Dart_NativeArguments args)
{
